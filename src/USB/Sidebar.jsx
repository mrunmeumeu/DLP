...
const menuItems = [
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/e952f119c916e716f4a93171a48969ff341d047766d5c870e61f46e40f554413?placeholderIfAbsent=true&apiKey=6780ef7663fb420989788dbe5af024d1", text: "Dashboard", link: "/dashboard", active: false },
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/3aa412be8bccf6d101ee840cee87ae5b1f96cb9d72e76b88b7b880fe2d456c08?placeholderIfAbsent=true&apiKey=6780ef7663fb420989788dbe5af024d1", text: "USB Monitoring", link: "/usb", active: true },
  ...
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/ede9ada030466c0e36b97103edd801b3d3f681d7798742dec6d3a7b5c133ce9c?placeholderIfAbsent=true&apiKey=6780ef7663fb420989788dbe5af024d1",link: "/behaveAna" , text: "Behavioural Analysis",active:false },
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/3d07a0a8e8c8aa92ef2744f1b291057188aba041ae266cbd3c91bbb01bf6a074?placeholderIfAbsent=true&apiKey=6780ef7663fb420989788dbe5af024d1",link: "/encryption" , text: "Encryption",active:false },
  ...
  return (
    <div className={styles.sidebarContainer}>
      ...
      <div className={styles.profileInfo}>
          <img 
            src="https://i.pinimg.com/736x/81/1e/54/811e54db04b643e9a84996b385ad6247.jpg" 
            alt="User profile" 
            className={styles.profileImage} 
          />
          <div className={styles.profileDetails}>
            <div className={styles.userName}>Pratyush.co</div>
